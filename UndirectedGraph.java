 ...
 */
public class UndirectedGraph<VertexType, EdgeType> implements GraphNeighbourhoodType<VertexType, EdgeType> {
    @Override
    public List<Vertex<VertexType>> getNeighbours(Vertex<VertexType> vertex, List<Edge<EdgeType>> edges) {
        ...
        for (Edge<EdgeType> edge : edges) {
            ...
            else if (edge.getSecondVertex() == vertex && neighbours.contains(edge.getFirstVertex()))
